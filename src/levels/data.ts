...
export const CHAPTERS: Chapter[] = [
  ...
  { index: 7, title: '段位与进阶', subtitle: '看懂级位与段位,规划你的棋力之路' },
]
...
export const LEVELS: Level[] = [
  ...
  },
  {
    ...
    expectNoCapture: true,
    teach:
      '你这颗孤零零的黑子被白棋上、左两面贴住,只剩 2 口 [[气]],随时有危险。最朴实也最坚实的办法,就是顺着开阔的方向"长"一手,和原来的子 [[双|并]]成一排两子 —— 气一下从 2 口涨到 4 口,白棋再难切断。这种并排的两子形就叫 [[双]],是新手最该养成的好习惯:**被贴就长,先把自己站稳。**',
  ...
  // ───────── 第 7 章 段位与进阶 ─────────
  {
    ...
    successText:
      '你现在大约是 20 级上下的入门棋手 —— 这正是所有高手的起点。接下来:常去 [[路|9 路]]棋盘实战、每天做几道死活题、复盘自己的败局,棋力就会一级级往上走。这套入门课到此结束,**祝你早日升上段位!**',
  },
]
